...
function Aptitude_w_Aptitude(apt1,apt2){
    this.aptitude1 = apt1, this.aptitude2 = apt2 }

function  Aptitude_w_Vulnerability(vuln1,vuln2){
...
module.exports.Aptitude_w_Aptitude = Aptitude_w_Aptitude;
module.exports.Aptitude_w_Vulnerability = Aptitude_w_Vulnerability;
